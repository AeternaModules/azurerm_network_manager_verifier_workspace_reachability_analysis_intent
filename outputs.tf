...
output "network_manager_verifier_workspace_reachability_analysis_intents_destination_resource_id" {
  ...
  value       = { for k, v in azurerm_network_manager_verifier_workspace_reachability_analysis_intent.network_manager_verifier_workspace_reachability_analysis_intents : k => v.destination_resource_id }
}
output "network_manager_verifier_workspace_reachability_analysis_intents_ip_traffic" {
  ...
  value       = { for k, v in azurerm_network_manager_verifier_workspace_reachability_analysis_intent.network_manager_verifier_workspace_reachability_analysis_intents : k => v.ip_traffic }
}
output "network_manager_verifier_workspace_reachability_analysis_intents_name" {
  ...
  value       = { for k, v in azurerm_network_manager_verifier_workspace_reachability_analysis_intent.network_manager_verifier_workspace_reachability_analysis_intents : k => v.name }
}
output "network_manager_verifier_workspace_reachability_analysis_intents_source_resource_id" {
  ...
  value       = { for k, v in azurerm_network_manager_verifier_workspace_reachability_analysis_intent.network_manager_verifier_workspace_reachability_analysis_intents : k => v.source_resource_id }
}
output "network_manager_verifier_workspace_reachability_analysis_intents_verifier_workspace_id" {
  ...
  value       = { for k, v in azurerm_network_manager_verifier_workspace_reachability_analysis_intent.network_manager_verifier_workspace_reachability_analysis_intents : k => v.verifier_workspace_id }
}
